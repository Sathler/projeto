...
const byte address[6] = "00001"; //CRIA UM ENDEREÇO PARA ENVIO DOS
...
void loop() {
  ...
  const char text2[] = "MasterWalker Shop"; //VARIÁVEL RECEBE A MENSAGEM A SER TRANSMITIDA
  radio.write(&text2, sizeof(text2)); //ENVIA AO RECEPTOR A MENSAGEM
